  ...
  return (
    <div className="p-8 bg-surface border border-border-default rounded-3xl">
      ...
      <p className="text-sm text-text-secondary text-center mb-4">
        Select an indexed repository from your local soleil-ai-review-engine server
      </p>
      ...
      {repos.length > 0 ? (
        ...
        <div className="text-center text-text-muted py-8">
          ...
          <p className="text-xs">
            Run{' '}
            <code className="px-1 py-0.5 bg-elevated rounded">soleil-ai-review-engine analyze</code>{' '}
            in a repository
          </p>
        </div>
      )}
