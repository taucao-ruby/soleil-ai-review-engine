...
This project is indexed by soleil-ai-review-engine as **soleil-ai-review-engine-web** (623 symbols, 1365 relationships, 44 execution flows). Use the soleil-ai-review-engine MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ soleil-ai-review-engine://repo/soleil-ai-review-engine-web/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `soleil-ai-review-engine://repo/soleil-ai-review-engine-web/context` | Codebase overview, check index freshness |
| `soleil-ai-review-engine://repo/soleil-ai-review-engine-web/clusters` | All functional areas |
| `soleil-ai-review-engine://repo/soleil-ai-review-engine-web/processes` | All execution flows |
| `soleil-ai-review-engine://repo/soleil-ai-review-engine-web/process/{name}` | Step-by-step execution trace |
