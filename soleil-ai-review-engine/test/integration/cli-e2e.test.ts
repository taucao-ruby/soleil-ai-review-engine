 ...
 * - analyzeCommand: verify pipeline runs and creates .soleil-ai-review-engine/ output
 *
...
afterAll(() => {
  // Clean up .git/ and .soleil-ai-review-engine/ directories created during the test
  for (const dir of ['.git', '.soleil-ai-review-engine']) {
...
describe('CLI end-to-end', () => {
  ...
  describe('unhappy path', () => {
    ...
    it('shows help with --help flag', () => {
      ...
      expect(result.stdout).toMatch(/soleil-ai-review-engine/i);
  ...
  describe('CLI error handling', () => {
    ...
    it('status on non-indexed repo reports not indexed', () => {
      ...
      // finds the parent project's .soleil-ai-review-engine. Use an isolated temp git
      // repo to guarantee no .soleil-ai-review-engine exists anywhere in the path.
