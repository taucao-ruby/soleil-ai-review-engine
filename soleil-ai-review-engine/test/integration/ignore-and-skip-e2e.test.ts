...
// ============================================================================
// E2E: .gitignore + .soleil-ai-review-engineignore + unsupported language skip
// ============================================================================
...
describe('ignore + language-skip E2E', () => {
  ...
  beforeAll(async () => {
    ...
    // .soleil-ai-review-engineignore — excludes vendor/
  ...
  describe('file discovery (walkRepositoryPaths)', () => {
    ...
    it('excludes soleil-ai-review-engineignored directories (vendor/)', async () => {
      const files = await walkRepositoryPaths(tmpDir);
      const paths = files.map(f => f.path.replace(/\\/g, '/'));
