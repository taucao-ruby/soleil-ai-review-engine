 ...
 *
 * Tests `soleil-ai-review-engine analyze --skills` across 11 supported languages plus
 ...
 * 1. CLI exits 0
 * 2. .soleil-ai-review-engine/ exists
...
function assertSkillFiles(
  ...
  expect(fs.existsSync(path.join(tmpDir, '.soleil-ai-review-engine'))).toBe(true);
