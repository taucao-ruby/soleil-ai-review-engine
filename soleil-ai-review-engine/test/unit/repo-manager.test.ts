...
describe('getStoragePath', () => {
  it('appends .soleil-ai-review-engine to resolved repo path', () => {
    const result = getStoragePath('/home/user/project');
    expect(result).toContain('.soleil-ai-review-engine');
    expect(path.basename(result)).toBe('.soleil-ai-review-engine');
  });
...
describe('getStoragePaths', () => {
  it('returns storagePath, lbugPath, metaPath', () => {
    ...
    expect(paths.storagePath).toContain('.soleil-ai-review-engine');
...
describe('readRegistry', () => {
  it('returns empty array when registry does not exist', async () => {
    // readRegistry reads from ~/.soleil-ai-review-engine/registry.json
...
describe('saveCLIConfig / loadCLIConfig', () => {
  ...
  beforeEach(async () => {
    tmpHandle = await createTempDir('soleil-ai-review-engine-config-test-');
