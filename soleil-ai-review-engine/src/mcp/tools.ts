 ...
 * 
 * Defines the tools that soleil-ai-review-engine exposes to external AI agents.
...
export const SOLEIL_AI_REVIEW_ENGINE_TOOLS: ToolDefinition[] = [
  {
    name: 'list_repos',
    description: `List all indexed repositories available to soleil-ai-review-engine.

Returns each repo's name, path, indexed date, last commit, and stats.

WHEN TO USE: First step when multiple repos are indexed, or to discover available repos.
AFTER THIS: READ soleil-ai-review-engine://repo/{name}/context for the repo you want to work with.
...
WHEN TO USE: Complex structural queries that search/explore can't answer. READ soleil-ai-review-engine://repo/{name}/schema first for the full schema.
...
AFTER THIS: Use impact() if planning changes, or READ soleil-ai-review-engine://repo/{name}/process/{processName} for full execution trace.
...
AFTER THIS: Review affected processes. Use context() on high-risk symbols. READ soleil-ai-review-engine://repo/{name}/process/{name} for full traces.
