 ...
 * Analyze Command
 *
 * Indexes a repository and stores the knowledge graph in .soleil-ai-review-engine/
 */
...
export const analyzeCommand = async (
  ...
  if (options?.verbose) {
    process.env.SOLEIL_AI_REVIEW_ENGINE_VERBOSE = '1';
  }

  console.log('\n  soleil-ai-review-engine Analyzer\n');
  ...
  if (process.env.SOLEIL_AI_REVIEW_ENGINE_NO_GITIGNORE) {
    console.log('  SOLEIL_AI_REVIEW_ENGINE_NO_GITIGNORE is set — skipping .gitignore (still reading .soleil-ai-review-engineignore)\n');
  }
  ...
  try {
    ...
    console.log('\n  Tip: Run `soleil-ai-review-engine setup` to configure MCP for your editor.');
  }
