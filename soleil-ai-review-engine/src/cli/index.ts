...
program
  ...
  .option('--skills', 'Generate repo-specific skill files from detected communities')
   ...
   .addHelpText('after', '\nEnvironment variables:\n  SOLEIL_AI_REVIEW_ENGINE_NO_GITIGNORE=1  Skip .gitignore parsing (still reads .soleil-ai-review-engineignore)')
...
program
  .command('clean')
  .description('Delete soleil-ai-review-engine index for current repo')
...
program
  ...
  .option('--api-key <key>', 'LLM API key (saved to ~/.soleil-ai-review-engine/config.json)')
