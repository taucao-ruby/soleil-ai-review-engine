...
This project is indexed by soleil-ai-review-engine as **soleil-ai-review-engine** (1999 symbols, 4681 relationships, 149 execution flows). Use the soleil-ai-review-engine MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ soleil-ai-review-engine://repo/soleil-ai-review-engine/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `soleil-ai-review-engine://repo/soleil-ai-review-engine/context` | Codebase overview, check index freshness |
| `soleil-ai-review-engine://repo/soleil-ai-review-engine/clusters` | All functional areas |
| `soleil-ai-review-engine://repo/soleil-ai-review-engine/processes` | All execution flows |
| `soleil-ai-review-engine://repo/soleil-ai-review-engine/process/{name}` | Step-by-step execution trace |
